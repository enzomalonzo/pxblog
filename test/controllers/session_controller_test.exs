defmodule Pxblog.SessionControllerTest do
  ...
  setup do
    role = TestHelper.create_role(%{name: "User", admin: false})
    _user = TestHelper.create_user(role, %{username: "test", password: "test", password_confirmation: "test", email: "test@test.com"})
